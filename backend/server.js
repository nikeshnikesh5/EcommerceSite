...
//   socket.broadcast.to(socketId).emit("admin closes chat","");
...
if(process.env.NODE_ENV === "production"){
  app.use(express.static(path.join(__dirname, "../wospee/build")));
  app.get("*",(req,res) => res.sendFile(apiRoutes.path.resolve(__dirname, "../wospee", "build" , index,html)));
